...
const validationSchema = Yup.object().shape({
	...
	address: Yup.string().required(texts.requiredAddress),
});
						...
						{({ handleSubmit }) => (
							<>
								<ScrollView style={{ paddingHorizontal: 20 }}>
									<View>
										<Text style={{ paddingHorizontal: 20, fontSize: 16 }}>Role</Text>
										<SelectField
											name="role"
											items={roleList}
									...
									<InputField style={styles.textInput} name="address" label="Address" />
									<InputField
										name="password"
										label="Password"
